...
func init() {
	proto.RegisterType((*PingMessage)(nil), "pinpoint.PingMessage")
}
...
func (c *coreClient) SayHello(ctx context.Context, in *PingMessage, opts ...grpc.CallOption) (*PingMessage, error) {
	out := new(PingMessage)
	err := grpc.Invoke(ctx, "/pinpoint.Core/SayHello", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Core_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pinpoint.Core/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).SayHello(ctx, req.(*PingMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptor0 = []byte{
	...
	0x71, 0x41, 0x7e, 0x5e, 0x71, 0xaa, 0x3e, 0x8c, 0x01, 0x91, 0x50, 0xd2, 0xe4, 0xe2, 0x0e, 0xc8,
	0xcc, 0x4b, 0xf7, 0x4d, 0x2d, 0x2e, 0x4e, 0x4c, 0x4f, 0x15, 0x92, 0xe2, 0xe2, 0x48, 0x2f, 0x4a,
	0x4d, 0x2d, 0xc9, 0xcc, 0x4b, 0x97, 0x60, 0x54, 0x60, 0xd4, 0xe0, 0x0c, 0x82, 0xf3, 0x8d, 0x4a,
	0xb8, 0x58, 0x9c, 0xf3, 0x8b, 0x52, 0x85, 0x0c, 0xb8, 0x38, 0xdd, 0x53, 0x4b, 0x82, 0x4b, 0x12,
	0x4b, 0x4a, 0x8b, 0x85, 0xf8, 0xf5, 0x60, 0x16, 0x41, 0x04, 0xa4, 0x04, 0xf4, 0xe0, 0x36, 0x40,
	0x44, 0x94, 0x18, 0x84, 0xac, 0xb8, 0x38, 0x82, 0x13, 0x2b, 0x3d, 0x52, 0x73, 0x72, 0xf2, 0x85,
	0x44, 0xf5, 0xe0, 0x6e, 0x47, 0xb2, 0x58, 0x0a, 0xbb, 0xb0, 0x12, 0x43, 0x12, 0x1b, 0xd8, 0x9d,
	0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x7a, 0x38, 0x82, 0xa9, 0xf3, 0x00, 0x00, 0x00,
}
